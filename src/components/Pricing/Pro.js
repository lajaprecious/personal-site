...
const Pro = () => {
  ...
  const pricingTable = [
    {
      mode: 'DATA STRUCTURES & ALGORITHMS',
      price: '$200',
      user: 'Tutoring',
      storage: 'Solution in Python | Java | JavaScript',
      projectsPublic: 'Mechanical calculation engineering',
      access: 'Robotic Process Automation',
      projectsPrivate: 'Unlimited Private Projects',
      phoneSupport: 'Database integration',
      domain: 'Detailed code comments',
      reports: 'Source code',
    },
  ];
